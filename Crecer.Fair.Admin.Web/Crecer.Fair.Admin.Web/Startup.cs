...
namespace Crecer.Fair.Admin.Web
{
    public class Startup
    {
        ...
        {
            services.AddGlobalOptions(Configuration);
            ...
            services.AddMvcDataTables();

            //services.AddWebOptimizer();
            // services.AddWebOptimizer(pipeline =>
            // {
            //     pipeline.CompileScssFiles();
            //     pipeline.AddScssBundle("/css/dark.css","/css/dark.scss");
            //     pipeline.AddScssBundle("/css/light.css","/css/light.scss");
            // });
        }
