...
wvy.messenger = (function ($) {
    ...
    window.addEventListener("message", function (e) {
        ...
        switch (e.data.name) {
            ...
            case "hide-list-conversations":
                hideListConversations();
                break;

            case "hide-header-conversation-actions":
                hideHeaderConversationsActions();
                break;
    ...
    function hideListConversations() {
        $(".pane-actions .btn-back").hide();
    }
    function hideHeaderConversationsActions() {
        $(".pane-header").find("[data-target='#new-message-modal']").hide();
        $(".pane-header").find(".btn.dropdown-toggle").hide();
    }
